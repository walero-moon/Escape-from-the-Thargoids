...
class MainMenu():
    ...
    def __init__(self, window):
        ...
        self._font_controls = pygame.font.SysFont("Dungeon", 20, bold=True)
    ...
    def update(self, selection, name):
        ...
        if selection == 'play':
            ...
            (position_x + 250, 500, 136, 70), width=5, border_radius=4)
        else:
            pygame.draw.rect(self._window, (255, 255, 255), 
            (position_x + 250, 500, 136, 70), width=5, border_radius=4)
        self._window.blit(play_text, (position_x + 270, 511))

        # Exit
        if selection == 'exit':
            pygame.draw.rect(self._window, (self._selection_colour), 
            (2 * position_x, 500, 124, 70), width=5, border_radius=4)
        else:
            pygame.draw.rect(self._window, (255, 255, 255), 
            (2 * position_x, 500, 124, 70), width=5, border_radius=4)
        self._window.blit(exit_text, (2 * position_x + 20, 511))
        # Blits controls
